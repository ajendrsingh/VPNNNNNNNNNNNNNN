package com.suiivpn.app.AdapterWrappers;
...
public class FBNativeAdapter extends RecyclerViewAdapterWrapper {
    ...
    private static final int TYPE_fb_nativeWilldev_ADS = 900;
    ...
    public int getItemViewType(int position) {
        if (isAdPosition(position)) {
            return TYPE_fb_nativeWilldev_ADS;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == TYPE_fb_nativeWilldev_ADS) {
    ...
    private RecyclerView.ViewHolder onCreateAdViewHolder(ViewGroup parent) {
        ...
        LinearLayout adLayoutContent = (LinearLayout) inflater
                .inflate(R.layout.facebook_native_ad_willdev, parent, false);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_fb_nativeWilldev_ADS) {
    ...
    public static class Builder {
        ...
        public static Builder with(String placementId, RecyclerView.Adapter wrapped) {
            ...
            param.itemContainerLayoutRes = R.layout.tab_outline_willdev;
            param.itemContainerId = R.id.native_adBannerWilldev_container;
    ...
    private static class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        AdViewHolder(View view) {
            super(view);
            nativeAdContainer = view.findViewById(R.id.native_adBannerWilldev_container);
